...
| `192.168.20.12` | `*.tpcf.lab.sampsoftware.net` | Tanzu Platform appliance (**deploy pending**) |
...
- For the appliance, add wildcard DNS `*.tpcf.lab.sampsoftware.net → 192.168.20.12` on the UDM
